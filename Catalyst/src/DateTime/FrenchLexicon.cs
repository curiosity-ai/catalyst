...
namespace Catalyst.DateTimeRecognition
{
    ...
    public static class FrenchLexicon
    {
        ...
        private static Lexicon Build()
        {
            ...
            b.Add(TermKind.Ago,     "il y a", "auparavant", "plus tôt");
            b.Add(TermKind.FromNow, "plus tard", "après", "apres", "dans le futur");
            ...
            return b.Build(Language.French, dayMonthOrder: true, decimalComma: true, articleInDateSpan: false, articleInPeriodSpan: true, relativeAfterUnit: true);
        }
    }
}
