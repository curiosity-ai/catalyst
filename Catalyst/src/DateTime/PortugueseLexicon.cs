...
namespace Catalyst.DateTimeRecognition
{
    ...
    public static class PortugueseLexicon
    {
        ...
        private static Lexicon Build()
        {
            ...
            b.Add(TermKind.Month, 12, "dezembro", "dez");

            b.Add(TermKind.Weekday, 0, "domingo", "domingos", "dom");
            b.Add(TermKind.Weekday, 1, "segunda", "segunda-feira", "segundas", "seg");
            b.Add(TermKind.Weekday, 2, "terça", "terca", "terça-feira", "ter");
            b.Add(TermKind.Weekday, 3, "quarta", "quarta-feira", "qua");
            b.Add(TermKind.Weekday, 4, "quinta", "quinta-feira", "qui");
            b.Add(TermKind.Weekday, 5, "sexta", "sexta-feira", "sex");
            ...
            b.Add(TermKind.Cardinal, 10, "dez");
            ...
            b.Add(TermKind.Ordinal,  2, "segundo");
            b.Add(TermKind.Ordinal,  3, "terceiro", "terceira");
            b.Add(TermKind.Ordinal,  4, "quarto");
            ...
            b.Add(TermKind.QuarterWord, "quarto");
            ...
            b.Add(TermKind.FromNow, "depois", "mais tarde", "a partir de agora");
            ...
            b.Add(TermKind.SetPrefix, 0, "cada", "todos", "todas", "todo", "toda");
            ...
            return b.Build(Language.Portuguese, dayMonthOrder: true, decimalComma: true, articleInDateSpan: false, articleInPeriodSpan: true);
        }
    }
}
