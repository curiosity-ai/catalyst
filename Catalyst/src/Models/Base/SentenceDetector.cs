...
namespace Catalyst.Models
{
    ...
    public class SentenceDetector : StorableObject<SentenceDetector, SentenceDetectorModel>, ISentenceDetector, IProcess
    {
        ...
        private static readonly int _Hash_Bias = GetHash("_HashBias");
        private static readonly int _Hash_True_IIsPunct = GetHash("TRUE_HashIIsPunct");
        private static readonly int _Hash_True_Im1IsCap = GetHash("TRUE_HashIm1IsCap");
        private static readonly int _Hash_True_Ip1IsCap = GetHash("TRUE_HashIp1IsCap");
        private static readonly int _Hash_True_Im1Upp = GetHash("TRUE_HashIm1Upp");
        private static readonly int _Hash_True_Ip1Upp = GetHash("TRUE_HashIp1Upp");
        private static readonly int _Hash_True_Im1Low = GetHash("TRUE_HashIm1Low");
        private static readonly int _Hash_True_Ip1Low = GetHash("TRUE_HashIp1Low");
        private static readonly int _Hash_True_IIsPunctIp1IsPunct = GetHash("TRUE_HashIIsPunctIp1IsPunct");
        private static readonly int _Hash_True_IIsPunctIm1IsPunct = GetHash("TRUE_HashIIsPunctIm1IsPunct");
        private static readonly int _Hash_True_IIsPunctIp2IsPunct = GetHash("TRUE_HashIIsPunctIp2IsPunct");
        private static readonly int _Hash_True_IIsPunctIm2IsPunct = GetHash("TRUE_HashIIsPunctIm2IsPunct");
        private static readonly int _Hash_True_IIsCurrency = GetHash("TRUE_HashIIsCurrency");
        private static readonly int _Hash_True_IIsNumeric = GetHash("TRUE_HashIIsNumeric");
        private static readonly int _Hash_True_IHasNumeric = GetHash("TRUE_HashIHasNumeric");
        private static readonly int _Hash_True_IsPunctIp1Quote = GetHash("TRUE_HashIsPunctIp1Quote");
        private static readonly int _Hash_True_IequalIm1 = GetHash("TRUE_HashIequalIm1");
        private static readonly int _Hash_True_IequalIm2 = GetHash("TRUE_HashIequalIm2");
        private static readonly int _Hash_True_IequalIp1 = GetHash("TRUE_HashIequalIp1");
        private static readonly int _Hash_True_IequalIp2 = GetHash("TRUE_HashIequalIp2");
        private static readonly int _Hash_True_Im1IsBOS = GetHash("TRUE_HashIm1IsBOS");
        private static readonly int _Hash_True_Im2IsBOS = GetHash("TRUE_HashIm2IsBOS");
        private static readonly int _Hash_True_Ip1IsEOS = GetHash("TRUE_HashIp1IsEOS");
        private static readonly int _Hash_True_Ip2IsEOS = GetHash("TRUE_HashIp2IsEOS");

        private static readonly int _Hash_False_IIsPunct = GetHash("FALSE_HashIIsPunct");
        private static readonly int _Hash_False_Im1IsCap = GetHash("FALSE_HashIm1IsCap");
        private static readonly int _Hash_False_Ip1IsCap = GetHash("FALSE_HashIp1IsCap");
        private static readonly int _Hash_False_Im1Upp = GetHash("FALSE_HashIm1Upp");
        private static readonly int _Hash_False_Ip1Upp = GetHash("FALSE_HashIp1Upp");
        private static readonly int _Hash_False_Im1Low = GetHash("FALSE_HashIm1Low");
        private static readonly int _Hash_False_Ip1Low = GetHash("FALSE_HashIp1Low");
        private static readonly int _Hash_False_IIsPunctIp1IsPunct = GetHash("FALSE_HashIIsPunctIp1IsPunct");
        private static readonly int _Hash_False_IIsPunctIm1IsPunct = GetHash("FALSE_HashIIsPunctIm1IsPunct");
        private static readonly int _Hash_False_IIsPunctIp2IsPunct = GetHash("FALSE_HashIIsPunctIp2IsPunct");
        private static readonly int _Hash_False_IIsPunctIm2IsPunct = GetHash("FALSE_HashIIsPunctIm2IsPunct");
        private static readonly int _Hash_False_IIsCurrency = GetHash("FALSE_HashIIsCurrency");
        private static readonly int _Hash_False_IIsNumeric = GetHash("FALSE_HashIIsNumeric");
        private static readonly int _Hash_False_IHasNumeric = GetHash("FALSE_HashIHasNumeric");
        private static readonly int _Hash_False_IsPunctIp1Quote = GetHash("FALSE_HashIsPunctIp1Quote");
        private static readonly int _Hash_False_IequalIm1 = GetHash("FALSE_HashIequalIm1");
        private static readonly int _Hash_False_IequalIm2 = GetHash("FALSE_HashIequalIm2");
        private static readonly int _Hash_False_IequalIp1 = GetHash("FALSE_HashIequalIp1");
        private static readonly int _Hash_False_IequalIp2 = GetHash("FALSE_HashIequalIp2");
        private static readonly int _Hash_False_Im1IsBOS = GetHash("FALSE_HashIm1IsBOS");
        private static readonly int _Hash_False_Im2IsBOS = GetHash("FALSE_HashIm2IsBOS");
        private static readonly int _Hash_False_Ip1IsEOS = GetHash("FALSE_HashIp1IsEOS");
        private static readonly int _Hash_False_Ip2IsEOS = GetHash("FALSE_HashIp2IsEOS");

        private static readonly int _Hash_FirstChar = GetHash("Hash_FirstChar");
        private static readonly int _Hash_Im1Length = GetHash("Hash_Im1Length");
        private static readonly int _Hash_Ip1Length = GetHash("Hash_Ip1Length");
