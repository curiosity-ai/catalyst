...
namespace Catalyst.Models
{
    public static partial class Luxembourgish_Letzeburgesch
    {
        internal sealed class Lemmatizer : ILemmatizer
        {
            ...
            private static Lazy<Lookups> _lookup = new Lazy<Lookups>(() => Lookups.FromStream(ResourceLoader.OpenResource(typeof(Lemmatizer).Assembly, "lb_lemma_lookup.bin")).WaitResult());
