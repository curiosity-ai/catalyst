...
namespace Catalyst.Models
{
    public static partial class Basque
    {
        public static void Register()
        {
            ...
            Catalyst.TokenizerExceptions.Register(Language.Basque, new Lazy<Dictionary<int, TokenizationException>>(() => TokenizerExceptions.Get(), System.Threading.LazyThreadSafetyMode.ExecutionAndPublication));
        }
    }
}
