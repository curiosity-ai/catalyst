...
namespace Catalyst.Models
{
    public static partial class Czech
    {
        internal sealed class Lemmatizer : ILemmatizer
        {
            ...
            private static Lazy<Lookups> _lookup = new Lazy<Lookups>(() => Lookups.FromStream(ResourceLoader.OpenResource(typeof(Lemmatizer).Assembly, "cs_lemma_lookup.bin")).WaitResult(), isThreadSafe:true);
