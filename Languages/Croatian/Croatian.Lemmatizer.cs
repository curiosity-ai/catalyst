...
namespace Catalyst.Models
{
    public static partial class Croatian
    {
        ...
        {
            public Language Language => Language.Croatian;

            private static Lazy<Lookups> _lookup = new Lazy<Lookups>(() => Lookups.FromStream(ResourceLoader.OpenResource(typeof(Lemmatizer).Assembly, "hr_lemma_lookup.bin")).WaitResult(), isThreadSafe:true);
