...
namespace Catalyst.Models
{
    public static partial class Norwegian_Bokmal
    {
        internal sealed class Lemmatizer : ILemmatizer
        {
            ...
            private static Lazy<Lookups> _lookup = new Lazy<Lookups>(() => Lookups.FromStream(ResourceLoader.OpenResource(typeof(Lemmatizer).Assembly, "nb_lemma_lookup.bin")).WaitResult());
