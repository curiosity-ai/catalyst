...
namespace Catalyst.Models
{
    public static partial class Catalan
    {
        internal sealed class Lemmatizer : ILemmatizer
        {
            ...
            private static Lazy<Lookups> _lookup = new Lazy<Lookups>(() => Lookups.FromStream(ResourceLoader.OpenResource(typeof(Lemmatizer).Assembly, "ca_lemma_lookup.bin")).WaitResult());
