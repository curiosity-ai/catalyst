...
namespace Catalyst.Models
{
    public static partial class Hungarian
    {
        ...
        {
            public Language Language => Language.Hungarian;

            private static Lazy<Lookups> _lookup = new Lazy<Lookups>(() => Lookups.FromStream(ResourceLoader.OpenResource(typeof(Lemmatizer).Assembly, "hu_lemma_lookup.bin")).WaitResult(), isThreadSafe:true);
