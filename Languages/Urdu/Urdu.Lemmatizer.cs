...
namespace Catalyst.Models
{
    public static partial class Urdu
    {
        ...
        {
            public Language Language => Language.Urdu;

            private static Lazy<Lookups> _lookup = new Lazy<Lookups>(() => Lookups.FromStream(ResourceLoader.OpenResource(typeof(Lemmatizer).Assembly, "ur_lemma_lookup.bin")).WaitResult(), isThreadSafe:true);
