...
namespace Catalyst.Models
{
    public static partial class Lithuanian
    {
        internal sealed class Lemmatizer : ILemmatizer
        {
            ...
            private static Lazy<Lookups> _lookup = new Lazy<Lookups>(() => Lookups.FromStream(ResourceLoader.OpenResource(typeof(Lemmatizer).Assembly, "lt_lemma_lookup.bin")).WaitResult());
