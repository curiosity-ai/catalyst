...
namespace Catalyst.Models
{
    public static partial class Lithuanian
    {
        ...
        {
            public Language Language => Language.Lithuanian;

            private static Lazy<Lookups> _lookup = new Lazy<Lookups>(() => Lookups.FromStream(ResourceLoader.OpenResource(typeof(Lemmatizer).Assembly, "lt_lemma_lookup.bin")).WaitResult(), isThreadSafe:true);
