...
namespace Catalyst.Models
{
    public static partial class Tagalog
    {
        internal sealed class Lemmatizer : ILemmatizer
        {
            ...
            private static Lazy<Lookups> _lookup = new Lazy<Lookups>(() => Lookups.FromStream(ResourceLoader.OpenResource(typeof(Lemmatizer).Assembly, "tl_lemma_lookup.bin")).WaitResult());
